...
public void sector_1(){ 
  ...
  translate(-0.5f,-0.5f); // move the scene to the center of the screen 
...
public void sector_2(){
  ...
  translate(0,SECTOR_SIZE-((SECTOR_SIZE-(SECTOR_SIZE*0.6f)))/2); // translate to sector 2
  // size after squish = 0.67 * 0.6 = 0.402 (0.67-0.402=0.268 space top and bottom -> 0.268/2 = 0.134 top)
  scale(1.1f,0.6f); // squish! 
  scale(SECTOR_SIZE); // scale to sector size
  translate(-0.5f,-0.5f); // move the scene to the center of the screen 
...
public void sector_4(){
  ...
  scale(SECTOR_SIZE); // scale to sector size
  scale(0.30f); // scale to 30%. Tiny!
  translate(PUPPY_CENTRE[0],PUPPY_CENTRE[1]); // move the PUPPY to the centre of the screen 
  translate(-0.5f,-0.5f); // move to the scence to center of the screen 
  ...
  translate(-SECTOR_SIZE+((GIRL_CENTRE[0]-0.5f)*SECTOR_SIZE),0); // translate to the sector 4
  scale(SECTOR_SIZE); // scale to sector size   
  scale(0.30f); // scale to 30%. Tiny!
  translate(-GIRL_CENTRE[0]+0.5f, 0);  // move the girl to the centre of the screen
  translate(-0.5f,-0.5f); // move the scene to the center of the screen 
...
public void sector_6(){
  
  // draw the PUPPY -------------------------------------------------------
  pushMatrix();

  translate(SECTOR_SIZE-(0.4f/(SECTOR_SIZE*10)),0); // translate to the sector 6
  scale(SECTOR_SIZE); // scale to sector size
  shearX(-0.4f); // shear by -40% along the x axis. The wind!
  translate(-0.5f,-0.5f); // move the scene to the center of the screen 
  ...
  translate(SECTOR_SIZE,-0.5f/(SECTOR_SIZE*10)); // translate to the sector 6
  scale(SECTOR_SIZE); // scale to sector size
  shearY(0.5f); // shear by 50% along the y axis. The Wind!
  translate(-0.5f,-0.5f); // move the scene to the center of the screen 
...
public void sector_7(){
  ...
  for(float i = -(SECTOR_SIZE/2); i < SECTOR_SIZE/2; i+=difference){
    ...
    translate(-SECTOR_SIZE-(PUPPY_CENTRE[0]*SECTOR_SIZE),-SECTOR_SIZE+0.04f); // translate to the sector 7
    translate(0,i); // translate up to the right place
    scale(SECTOR_SIZE); // scale to sector size
    scale(0.20f); // scale to 20%
